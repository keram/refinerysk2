...
Refinery::Resources.configure do |config|
  ...
  # Configure how many resources per page should be displayed in the list of resources in the dialog
  # config.per_dialog_page = 12
  ...
  # config.datastore_root_path = "/home/keram/work/keramovo/refinerysk/refinerysk/public/system/refinery/resources"
